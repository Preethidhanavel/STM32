...
DMA_HandleTypeDef hdma_memtomem_dma1_channel1;// DMA handle for memory-to-memory transfer using DMA1 Channel1
/* USER CODE BEGIN PV */
uint8_t src_buffer[100];   // Source array
uint8_t dst_buffer[100];   // Destination array
/* USER CODE END PV */
...
int main(void)
{
  ...
  // Start memory-to-memory DMA transfer
