...
uint8_t txData[] = "Hello SPI";  // Data to send via SPI
uint8_t rxData[10] = {0};        // Buffer to store received SPI data
...
UART_HandleTypeDef huart2; // UART2 handle for debugging/printing
...
int main(void)
{
  ...
  MX_SPI1_Init();
  /* USER CODE BEGIN 2 */
  // Pull CS high initially (deselect slave)
