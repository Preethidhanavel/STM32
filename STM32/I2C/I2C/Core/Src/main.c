...
#include<stdio.h>
#include"string.h"
// ADXL345 I2C 7-bit address shifted left by 1 for STM32 HAL functions
#define ADXL345_ADDR  0x53 << 1  

// Array to store 6 bytes of accelerometer data: X0, X1, Y0, Y1, Z0, Z1
uint8_t accel_data[6];

// Variables to store X, Y, Z acceleration values after combining MSB and LSB
int16_t x, y, z;

// Buffer to store formatted UART messages
char msg[64];
...
/* Private variables ---------------------------------------------------------*/
I2C_HandleTypeDef hi2c1;  // Handle for I2C1
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
   ADXL345_Init();  // Initialize accelerometer
    ...
    /* Infinite loop to continuously read accelerometer */
    while (1)
    {
